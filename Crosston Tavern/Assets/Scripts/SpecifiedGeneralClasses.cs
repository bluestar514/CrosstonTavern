...
{ }[Serializable]public class RelationTagListStorage : SerializableDictionary.Storage<List<Relationship.RelationshipTag>> { }[Serializable]public class StringRelationTagsDictionary : SerializableDictionary<string, List<Relationship.RelationshipTag>, RelationTagListStorage> { }[Serializable]public class FloatArrayStorage : SerializableDictionary.Storage<float[]> { }[Serializable]public class StringFloatArrayDictionary : SerializableDictionary<string, float[], FloatArrayStorage> { }
