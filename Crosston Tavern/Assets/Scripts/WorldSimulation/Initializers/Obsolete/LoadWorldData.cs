...
public class LoadWorldData
{
    ...
    public WorldState BuildWorld()
    {
        ...
        //WorldState ws = new WorldState(map, null, worldTime);

        //SetRelations(ws.registry);
        //SetGoals(ws, people);

        Debug.LogWarning("This class has been majorly gutted. Do not take it not screaming to mean that everything is working as intended!");
        //return ws;
        return null;
    }
    ...
    //void AddPeopleToFeatures(List<Feature> features, List<Person_old> people, Dictionary<string, GenericAction> actions)
    //{
    //    foreach (Person_old person in people) {
